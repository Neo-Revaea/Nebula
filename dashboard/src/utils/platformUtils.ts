...
export function getTutorialLink(platformType: string): string {
  const tutorialMap: Record<string, string> = {
    qq_official_webhook:
      'https://docs.astrbot.app/deploy/platform/qqofficial/webhook.html',
    qq_official:
      'https://docs.astrbot.app/deploy/platform/qqofficial/websockets.html',
    ...
    wechatpadpro:
      'https://docs.astrbot.app/deploy/platform/wechat/wechatpadpro.html',
    weixin_official_account:
      'https://docs.astrbot.app/deploy/platform/weixin-official-account.html',
