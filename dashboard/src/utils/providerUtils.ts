...
export function getProviderIcon(type: string): string {
  const icons: Record<string, string> = {
    ...
    azure:
      'https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/azure.svg',
    ...
    google:
      'https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/gemini-color.svg',
    deepseek:
      'https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/deepseek.svg',
    modelscope:
      'https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/modelscope.svg',
    zhipu:
      'https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/zhipu.svg',
    siliconflow:
      'https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/siliconcloud.svg',
    moonshot:
      'https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/kimi.svg',
