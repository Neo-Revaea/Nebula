...
export default [
  ...
  // Gradual rollout: forbid explicit `any` in selected areas first.
  {
    files: [
      ...
      'src/components/extension/componentPanel/index.vue',
      'src/components/extension/componentPanel/composables/useComponentData.ts',
      'src/components/extension/componentPanel/composables/useCommandActions.ts',
      'src/components/extension/SkillsSection.vue',
      'src/components/extension/McpServersSection.vue',
      'src/components/extension/InstalledExtensionsSection.vue',
      'src/composables/extension/useInstalledPlugins.ts',
      'src/composables/extension/usePluginMarket.ts',
      'src/composables/extension/usePluginInstall.ts',
      'src/composables/extension/usePluginSources.ts',
      'src/composables/extension/useLoadingDialog.ts',
      'src/composables/extension/useExtensionPage.ts',
