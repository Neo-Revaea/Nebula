...
export default defineConfig(() => {
  ...
  return {
    ...
    optimizeDeps: {
      exclude: ['vuetify', 'stream-monaco', '@guolao/vue-monaco-editor'],
      entries: ['./src/**/*.vue'],
    },
    server: {
      host: '0.0.0.0',
